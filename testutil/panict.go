...
// Errorf implements the [require.TestingT] interface for PanicT.  It panics
// with an error with the given format.
func (PanicT) Errorf(format string, args ...any) {
	panic(fmt.Errorf(format, args...))
}

// FailNow implements the [require.TestingT] interface for PanicT.  It is
// assumed that it will never actually be called, since [PanicT.Errorf] panics.
func (PanicT) FailNow() {
	panic("test failed")
}
